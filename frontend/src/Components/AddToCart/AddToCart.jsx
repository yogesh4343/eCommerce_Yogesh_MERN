...
const AddToCart = () => {
  ...
  // console.log(`cart` , cartItems[1].product ,`quantity`)
  
  console.log("addToCart" , loadUser.status != true);
  // console.log("addToCart" , JSON.stringify(loadUser) === '{}');
  ...
  const increaseQuantity=(product , quantity , stock)=>{
    ...
    //   return;
    // }
    // dispatch(addToCartReducer(product, newQty));
  }
  ...
  <div className="h-full bg-gray-100 pt-20">
    ...
    <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
       ...
       {/* <NavLink to="/shippingInfo"> <button className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={checkoutHandler}>Check out</button> </NavLink> */}
